...
import {faCircleUser, faAddressCard,faGear,faBook,faCalendar, faArrowRight, faArrowDown, faUserCircle} from "@fortawesome/free-solid-svg-icons";
    ...
    <nav className="nav">
        ...
        {isAuthenticated ? (
          <div className="mobile-user-section">
            ...
            <div className="mobile-nav-links">
              <Link to="/user/dashboard" className="mobile-nav-item" onClick={closeMenus}>
      ...
      <div className="desktop-user-section">
          ...
          <div className="user-info" ref={userMenuRef}>
            ...
            {userMenuOpen && (
              <div className="user-dropdown">
                <Link to="/user/dashboard" className="dropdown-item" onClick={closeMenus}>
                  <FontAwesomeIcon icon={faBook} /> Dashboard
                </Link>
                <Link to="/user/dashboard" className="dropdown-item" onClick={closeMenus}>
                  <FontAwesomeIcon icon={faCalendar} /> My Bookings
        ...
        <button className="book-now-btn" onClick={handleBookNow}>
          <FontAwesomeIcon icon={faCalendar} />{isAuthenticated ? 'Book Service' : 'Book Now'}
        </button>
      </div>

      {/* Overlay for mobile */}
      {isMenuOpen && <div className="menu-overlay" onClick={closeMenus}></div>}
    </nav>
  </header>
);
}
